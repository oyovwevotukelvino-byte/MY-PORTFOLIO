...
function Experience() {
  return (
    <section id="experience" className="w-full py-24 px-6 bg-black/20">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent neon-text glow">
            Experience Timeline
          </h2>
        ...
        <div className="relative">
          ...
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-emerald-500/30 to-teal-500/30 glow" />
          ...
          <div className="space-y-12">
            {experience.map((exp, index) => (
              <Motion.div
                ...
                className={`relative flex md:flex-row gap-8 items-start ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}
              >
                {/* Timeline Dot */}
                <div className="absolute -left-4 md:left-1/2 transform -translate-x-1/2 md:-translate-x-1/2 top-6 w-6 h-6 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full glow shadow-xl border-4 border-black z-10" />

                {/* Content */}
                <div className="flex-1 p-8 rounded-2xl bg-gray-900/50 backdrop-blur-md border border-white/20 glow-hover hover:border-emerald-500/50 transition-all md:w-2/3">
